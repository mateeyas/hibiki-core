...
def configure_logging(namespace: str = "app", extra_loggers: Optional[List[str]] = None):
    """
...
def setup_db_logging(session_maker, log_model, discord_config_model=None, namespace: str = "app"):
    """
    ...
    """
    global async_session_maker, Log, DB_LOG_MIN_LEVEL, DISCORD_LOG_MIN_LEVEL, DiscordNotificationConfig, _logger_namespace
